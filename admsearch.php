...
{
$q=$_POST['text7'];
$sql_res=mysql_query("SELECT * FROM  `products` WHERE proname like '%$q%'  ");
...
<span class="name"><a href="adminedit.php?prona=<?php echo $row['proname']; ?>" ><?php echo $row['proname']; ?></a></span>&nbsp;<br/>
</div>
</div>
<?php
}
