...
<title>Online Grocery Shopping|Online Grocery Shopping Trichy|Grocery Shopping Trichy</title>

<meta name="description" Content="Trichy based online grocery shopping. We are selling the various grocery products with good offers price, home delivery, 24 hours services available so you buy the products at any time." />
<meta name="Keyword" Content="Online grocery shopping,Online grocery shopping trichy,Grocery shopping trichy,Online supermarket trichy,Supermarket in trichy " />
...
<div class="ecomslider">
        ...
        margin-left:10px;margin-bottom:10px;margin-right:10px; overflow: hidden;">
             <div>
                <a u=image href="#"><img src="images/maligai.jpg" alt="Online Grocery Shopping"/></a>

            </div>
             <div>
                <a u=image href="#"><img src="images/Contact-banner.png" alt="Online grocery shopping trichy"/></a>

            </div>

            <div>
                <a u=image href="#"><img src="images/banner9.jpg" alt="Grocery shopping trichy" /></a>

            </div>

            <div>
                <a u=image href="#"><img src="images/laundry_products.jpg"  alt="Online Supermarket Trichy"/></a>

            </div>
              <div>
                <a u=image href="#"><img src="images/credit-card-accepted1.jpg" alt="Supermarket in trichy"/></a>

            </div>
             <div>
                <a u=image href="#"><img src="images/babycare1.jpg" alt="Online Grocery Shopping" /></a>

            </div>
            <div>
                <a u=image href="#"><img src="images/pooja-items-banner.png"  alt="Online grocery shopping trichy" /></a>

            </div>
             <div>
                <a u=image href="#"><img src="images/gift.jpg"  alt="Grocery shopping trichy" /></a>

                </div>

             <div>
                <a u=image href="#"><img src="images/credit-card-accepted.jpg"  alt="Online Grocery Shopping" /></a>
...
$_SESSION['page']=$id;
	...
	*/
	...
	$targetpage = "http://maligai.net/index.php"; 	//your file name  (the name of this file)
	...
	*/
	...
	if($lastpage > 1)
	{
		...
		while($r9 = mysqli_fetch_array($result))
			{
			$autoid=$r9['autoid'];
			$id=$r9['id'];
            ?>
...
<div class="iitem">
                                ...
                                <div class="cartbut">
                                <form name="for" action="productview.php?id=<?php echo $r9['autoid']; ?>" method="post">
...
<?php
  ...
  {
 echo '<p class="subdescription fR">'.$r9['price'].'</p>';
...
<!-- Start of StatCounter Code for Default Guide -->
<script type="text/javascript">
var sc_project=9872454;
var sc_invisible=0;
var sc_security="221f318e";
var scJsHost = (("https:" == document.location.protocol) ?
"https://secure." : "http://www.");
document.write("<sc"+"ript type='text/javascript' src='" +
scJsHost+
...
target="_blank"><img class="statcounter"
src="http://c.statcounter.com/9872454/0/221f318e/0/"
