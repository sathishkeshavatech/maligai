...
<ul class="upmenu">
         ...
         <div class="poweredname">POLCIES: <a href="Terms-condition.php">Terms&Conditions </a>|  <a href="privacy.php">Privacy</a> </div>
         <br />
...
while($r32 = mysql_fetch_array($result))
 ...
 ?>
 <a  href="categorycollections2.php?brand=<?php echo $brand;?>" style="color:#F00; padding-left:5px; text-decoration:none; margin-top:20px;margin-bottom:20px;"><?php echo $brand." ";?>-</a>
  <?php } ?>  
</div>
</div>
...
<br />
<p style="color:#fee">sign Up for Newsletter</p>
...
<a href="https://www.facebook.com/TrichyMaligai" target="_blank" title="Facebook" style="margin:5px;"><img src="images/facebook.png" /></a>&nbsp;<a href="" target="_blank" title="Twitter"  style="margin:5px;"><img src="images/twitter.png" /></a>&nbsp;<a href="" target="_blank" title="Google Plus"  style="margin:5px;"><img src="images/googleplus.png" /></a>
</div>
