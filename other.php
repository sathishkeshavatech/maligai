...
<?php
 ...
 <div style="width:400px; height:400px; alignment-adjust:middle;  margin-left:120px; margin-top:20px;padding-top:20px; line-height:30px;">
 <a href="#" style="text-decoration:none; margin-bottom:20px; font-size:15px; "><img src="images/tick1.png" width="20px" height="20px" />&nbsp;&nbsp; Medicines</a> <br/>
  <a href="#" style="text-decoration:none; font-size:15px;"><img src="images/tick1.png" width="20px" height="20px" />&nbsp;&nbsp;Air Conditioner</a><br/>
   <a href="#" style="text-decoration:none; font-size:15px;"><img src="images/tick1.png" width="20px" height="20px" />&nbsp;&nbsp;Electronic Items</a>
 </div> 
