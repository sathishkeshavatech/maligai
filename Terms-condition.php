...
<?php
 ...
 <h2  class="hlog" align="left">Terms & Conditions</h2>
 
 <p style="margin-left:15px; margin-right:15px; font-size:15px;    font-family: Arial;">The<span style="color:#C30;"> www.maligai.net </span>is owned and operated by the company Ishya Purple & Blue.</p>  
