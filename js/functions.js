...
if (document.getElementById && document.getElementsByTagName) {
	document.write("<link type=\"text/css\" rel=\"stylesheet\" href=\"css/jsmenustyle.css\" />");
}
...
$(document).ready(function(){ 
	if (document.getElementById && document.getElementsByTagName) {
		var myMenu = document.getElementById("menu3").getElementsByTagName("A");
		if (!myMenu) { return; }
		else {
